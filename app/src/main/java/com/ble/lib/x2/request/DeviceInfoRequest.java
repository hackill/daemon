 ...
 * @date 11/10/15.
 */
public class DeviceInfoRequest extends Request<BtDataReq.bt_data_req, BtDeviceInfo.bt_device_info> {

    public DeviceInfoRequest(@NonNull Response<BtDeviceInfo.bt_device_info> mResponse) {
