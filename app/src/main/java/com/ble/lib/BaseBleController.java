...
import cn.ginshell.bong.misc.GattError;
import cn.ginshell.bong.utils.CommonUtil;

/**
 * *Created by hackill on 5/26/16.
 */
...
//        mState = STATE.CONNECTING;
    ...
    BluetoothAdapter.LeScanCallback mScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            ...
            if (!mFoundDFUDevice.get() && TextUtils.equals(device.getAddress(), CommonUtil.addMacOne(mAddress))) {
                Log.e(TAG, "onLeScan: find dfu device: " + CommonUtil.addMacOne(mAddress));
...
//        mState = STATE.DISCONNECTING;
    ...
    /**
     * error address is empty , 0 is correct
     */
...
// Check characteristic property
    ...
    protected void setBleState(STATE state) {
        if (mState != state) {
            ...
            Intent intent = new Intent(Constant.Intent.BLE_STATE_CHANGE);
